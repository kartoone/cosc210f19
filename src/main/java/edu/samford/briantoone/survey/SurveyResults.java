...
public class SurveyResults {
    ...
    public static int MAXFILES = 100; // assume that we will never have more than 100 responses to parse
    ...
    /**
     * Process all the responses by calculating the averages and joining all the freeform responses by pipes. Also, displays everything
     */
